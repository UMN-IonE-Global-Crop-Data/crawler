...
# (1) barley(('Cebada forrajera en verde','Cebada grano')), (2) cassava(Yuca alimenticia), (3) maize(Maíz grano, Elote,Maíz forrajero en verde,Maíz palomero,Semilla de maíz grano), 
# (4) rapeseed/canola and mustard (Colza/Canola/(到这里)Canola forrajera and mostaza), 
...
# (8) sugarcane(Caña de azúcar,Caña de azúcar otro uso(~for other uses),Semilla de caña de azúcar), (9) wheat(Trigo grano, Trigo forrajero verde,Semilla de trigo grano), 
...
# (20) sunflower(Girasol, Semilla de girasol,Girasol forrajero), (21) banana(Plátano), (22) rubber(Hule hevea), (23) tea(Té limón?), (24) tomato(Tomate rojo (jitomate), Tomate verde), (25) onion(Cebolla)
...
#input_gen(crop = "Semilla de girasol")
input_gen(states=["Sub"], crop = "Girasol forrajero")
