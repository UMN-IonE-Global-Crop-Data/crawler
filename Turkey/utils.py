...
class Utils:
    ...
    def reload_page_and_select_crop_type(self, crop_type, crop_type_map):
        ...
        ok_button = Webself.driverWait(self.driver, 10).until(
    ...
    def unclick_crop(self, index, page, total_index):
        ...
        if (page == 1 and index > 1) or (page > 1 and index > 0):
            ...
            self.change_page(self.driver, page)
    ...
    def select_crop_and_unit(self, index, page, total_index):
        ...
        unclick_crop(self.driver, index, page, total_index)

        # 取消之前的unit
        if total_index != 0:
            select_unit(self.driver, total_index)

        # for i in range(0, len(crop_table)):
        #     print(f'index : {i}, item: {crop_table[i].text}')
        change_page(self.driver, page)
    ...
    def select_all_years(self):
        all_year_button = Webself.driverWait(self.driver, 10).until(
    ...
    def select_all_regions(self, level):
        ...
        try:
            option = Webself.driverWait(self.driver, 10).until(
        ...
        # select all regions
        all_region_button = Webself.driverWait(self.driver, 10).until(
    ...
    def generate_report(self):
        ...
        try:
            xslx_button = Webself.driverWait(self.driver, 15).until(
